...
function getAccessToken(client) {
  ...
  .catch(function(err) {
    console.log('Doesn\'t look like your refresh token is good, let me get you a new one.');
    console.log('You should go to ' + client.app.asanaAuthorizeUrl() + ' and copy the code there');
    ...
    rl.question('What was the code?\n\nCode: ', function(code) {
      ...
      .then(function(credentials) {
          console.log('Copy the following refresh token into your config file, and then restart this application:\n\n' + credentials.refresh_token);
        })
    });
  });
}
...
function syncTasks(client, accessToken) {
  ...
  client.useOauth({ credentials: accessToken });
